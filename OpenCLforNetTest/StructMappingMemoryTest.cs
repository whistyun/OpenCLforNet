...
namespace OpenCLforNetTest
{
    ...
    public class StructMappingMemoryTest : TestBase
    {
        ...
        {
            using (var mem = new MappingMemory<MyMappingStruct>(Context, 20))
            {
        ...
        {
            using (var mem = new MappingMemory<MyMappingStruct>(Context, 100))
            {
        ...
        public void ShaderTest()
        {
            ...
            using (var kernel = program.CreateKernel("testKernel"))
            {
                ...
                using (var mem = new MappingMemory<MySimpleStruct>(Context, 100))
                {
